...
def get_dataloader(dataset, tokenizer, args, split='train'):
    ...
    if split == 'train':
        dataloader = DataLoader(dataset, sampler=sampler, batch_size=batch_size, drop_last=True, collate_fn=collate)
    else:
        dataloader = DataLoader(dataset, sampler=sampler, batch_size=batch_size, drop_last=False, collate_fn=collate)
